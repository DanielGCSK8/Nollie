...
<head>
    ...
    <title>{{ config('app.name', 'Nollie') }}</title>

    <!-- Scripts -->
    <!-- <script src="{{ asset('js/app.js') }}" defer></script> -->
    <script src="{{ asset('UpdateCart/main.js') }}" defer></script>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        @if(Auth::user()->role_id=='1')
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/admin/users">Ver usuarios</a>
                            </li>
                    ...
                    <a class="navbar-brand" href="{{ url('cart/show') }}"> 
